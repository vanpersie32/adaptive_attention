...
tf.flags.DEFINE_string('data_h5','./data/mscoco_challenge/test/test.h5','the place of hdf5 file that contains image information')
tf.flags.DEFINE_string('data_json','./data/mscoco_challenge/test/test.json','the place of json file that contains image meta information and vocabulary information')
tf.flags.DEFINE_string('attributes_h5','./data/mscoco_challenge/test/tag_feats.h5','the place of h5 file that contains image attributes information')
